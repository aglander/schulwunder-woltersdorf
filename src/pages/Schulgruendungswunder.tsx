            ...
            <div className="sticky top-20">
              <nav className="bg-white rounded-lg shadow-lg p-4">
                <ul className="space-y-2">
                  <li>
                    <a href="#description" className="text-schulgruendung hover:underline block py-2">
                      Beschreibung
                    </a>
                  </li>
                  <li>
                    <a href="#updates" className="text-schulgruendung hover:underline block py-2">
                      Aktuelles
                    </a>
                  </li>
                  <li>
                    <a href="#team" className="text-schulgruendung hover:underline block py-2">
                      Team
                    </a>
                  </li>
                  <li>
                    <a href="#supporters" className="text-schulgruendung hover:underline block py-2">
                      Unterstützer
                    </a>
                  </li>
                </ul>
