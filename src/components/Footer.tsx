        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/kontakt" className={`text-gray-700 transition-colors ${hoverClass}`}>Kontakt</a></li>
              <li><a href="/impressum" className={`text-gray-700 transition-colors ${hoverClass}`}>Impressum</a></li>
              <li><a href="/datenschutz" className={`text-gray-700 transition-colors ${hoverClass}`}>Datenschutz</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-lg mb-4">Folgen Sie uns</h4>
            <div className="flex space-x-4">
              <a href="#" className={`text-gray-700 transition-colors ${hoverClass}`}>Instagram</a>
              <a href="#" className={`text-gray-700 transition-colors ${hoverClass}`}>YouTube</a>
            </div>
          </div>
        </div>
