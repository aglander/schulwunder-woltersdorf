...
export const SupporterSection = ({
  ...
  return (
    <Section title="Unsere Unterstützer" id="supporters" textColor={textColor}>
      ...
      {supporters.length > 0 ? (
        ...
        <p className="text-gray-600">
          Wir sind auf der Suche nach Unterstützern für unser Projekt. Bei
          Interesse kontaktieren Sie bitte Johannes Wilk unter{" "}
          <a
