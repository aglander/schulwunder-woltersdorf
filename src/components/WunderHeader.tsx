          ...
          <div className="container mx-auto px-4 h-16 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Link to="/" className="flex items-center gap-2 text-white hover:text-white/80 transition-colors">
                ...
                {!isMobile && <span className="font-semibold">
              ...
              <div className="text-white">
                <div className="relative inline-block px-24">
                  ...
                  bottom: '-35px'
                    ...
                    <img src="/assets/swish.svg" alt="" className={`w-full h-full object-contain ${location.pathname.includes('schulbau') ? 'filter-red' : 'brightness-0'}`} style={location.pathname.includes('schulbau') ? {
                    filter: 'brightness(0) saturate(100%) invert(27%) sepia(91%) saturate(2760%) hue-rotate(343deg) brightness(85%) contrast(95%)'
                  } : {}} aria-hidden="true" />
                  </div>
                  <h1 ref={h1Ref} lang="de" style={{
